...
const plans: Plan[] = [
  {
    ...
    popular: false,
    priceId: isDev ? PRICE_IDS.basic.dev : PRICE_IDS.basic.prod,
  },
  {
    name: "Pro Plan",
    price: "16.99",
    ...
    buttonText: "Subscribe Now",
    popular: true,
    priceId: isDev ? PRICE_IDS.pro.dev : PRICE_IDS.pro.prod,
  },
  {
    ...
    buttonText: "Subscribe Now",
    popular: false,
    priceId: isDev ? PRICE_IDS.enterprise.dev : PRICE_IDS.enterprise.prod,
  },
];
