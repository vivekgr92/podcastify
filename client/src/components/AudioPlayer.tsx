...
export default function AudioPlayer() {
  ...
  // Auto-hide player when no audio
  if (!audioData) {
    return null;
  }

  return (
    <div className="w-full h-24 bg-black border-t border-gray-800 fixed bottom-0 left-0 right-0 z-50">
        ...
        <div className="flex flex-col items-center gap-2 flex-1 max-w-[600px]">
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              className="h-10 w-10 rounded-full border-none bg-[#4CAF50] hover:bg-[#45a049] text-white"
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="text-white hover:text-white hover:bg-[#4CAF50]/20 relative"
